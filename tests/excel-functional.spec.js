 ...
 * Reads test cases directly from test-data/IT23286832_Test_Cases.xlsx
 */

// Helper function to read and parse Excel data
function readTestCases() {
    const excelPath = path.resolve(__dirname, '../test-data/IT23286832_Test_Cases.xlsx');
    const workbook = XLSX.readFile(excelPath);
    const sheetName = ' Test cases'; // Note the leading space based on debug
